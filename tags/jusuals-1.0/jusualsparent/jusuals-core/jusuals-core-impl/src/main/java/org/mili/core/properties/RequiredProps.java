...
/**
 * This class defines methods for access properties on required way.
 *
 * @author Michael Lieshoff
 */

class RequiredProps extends GenericProps {
    ...
    <T> T get(Properties properties, String key, Class<T> clazz) {
        return Props.get(properties, key, Props.Usage.REQUIRED_NOT_NULL_AND_NOT_EMPTY, clazz);
    }
