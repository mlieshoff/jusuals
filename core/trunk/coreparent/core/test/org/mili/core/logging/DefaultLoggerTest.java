...
public class DefaultLoggerTest {
    ...
    public void testWarnThrowableObjectArray() {
        this.logger.getLogger().setLevel(Level.WARN);
    ...
    public void testDebugThrowableObjectArray() {
        this.logger.getLogger().setLevel(Level.DEBUG);
    ...
    public void testInfoThrowableObjectArray() {
        this.logger.getLogger().setLevel(Level.INFO);
    ...
    public void testErrorThrowableObjectArray() {
        this.logger.getLogger().setLevel(Level.ERROR);
    ...
    public void testFatalThrowableObjectArray() {
        this.logger.getLogger().setLevel(Level.FATAL);
    ...
    public void testGetLogger() {
        assertNotNull(this.logger.getLogger());
    }
